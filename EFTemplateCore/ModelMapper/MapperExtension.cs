...
namespace EFTemplateCore.ModelMapper
{
    public static class MapperExtension
    {
        ...
        public static List<DTO> ToDtoList<ENTITY, DTO>(this List<ENTITY> source) { return MapHelper<ENTITY, DTO>.Convert(source); }
        public static ENTITY ToEntity<DTO, ENTITY>(this DTO view) where DTO : IDto { return MapHelper<DTO, ENTITY>.Convert(view); }
        public static List<ENTITY> ToEntityList<DTO, ENTITY>(this List<DTO> source) { return MapHelper<DTO, ENTITY>.Convert(source); }
    }
}
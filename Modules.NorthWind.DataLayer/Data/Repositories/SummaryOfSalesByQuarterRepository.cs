...
public class SummaryOfSalesByQuarterRepository : GenericRepository<SummaryOfSalesByQuarter> , ISummaryOfSalesByQuarterRepository<SummaryOfSalesByQuarter>
{
    public SummaryOfSalesByQuarterRepository(EFContext context, string safeCode)
        : base(context, safeCode)
    {
    }
    public SummaryOfSalesByQuarterRepository(EFContext context)
        : base(context)
    {
    }
	    public SummaryOfSalesByQuarter GetSummaryOfSalesByQuarterByKey(int OrderId)
    {

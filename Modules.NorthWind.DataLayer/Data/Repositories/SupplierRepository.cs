...
public class SupplierRepository : GenericRepository<Supplier> , ISupplierRepository<Supplier>
{
    public SupplierRepository(EFContext context, string safeCode)
        ...
        : base(context)
    {
	    ...
	    public Supplier GetSupplierByKey(int SupplierId)
    {
        return FirstOrDefault(p => p.SupplierId==SupplierId);
    }
	}
}
// </auto-generated>

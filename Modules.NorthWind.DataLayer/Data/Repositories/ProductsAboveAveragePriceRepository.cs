...
public class ProductsAboveAveragePriceRepository : GenericRepository<ProductsAboveAveragePrice> , IProductsAboveAveragePriceRepository<ProductsAboveAveragePrice>
{
    public ProductsAboveAveragePriceRepository(EFContext context, string safeCode)
        : base(context, safeCode)
    {
    }
    public ProductsAboveAveragePriceRepository(EFContext context)
        : base(context)
    {
    }
	    public ProductsAboveAveragePrice GetProductsAboveAveragePriceByKey(string ProductName)
    {
        return FirstOrDefault(p => p.ProductName==ProductName);
    }
	}
}
// </auto-generated>
